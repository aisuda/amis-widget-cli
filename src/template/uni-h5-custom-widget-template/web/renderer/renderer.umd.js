...
(function (global2, factory) {
  ...
  */
  ...
  const h5UniInfoCard_vue_vue_type_style_index_0_scoped_31459c9c_lang = '';
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      vue.openBlock(),
      vue.createElementBlock('div', { class: 'news-card' }, [
        ...
        vue.createElementVNode('div', { class: 'news-info' }, [
          ...
          vue.createElementVNode(
            ...
            { class: 'cmt-num right' },
            vue.toDisplayString(
              $options.agreeDataFormat($options.comment_count) || 0,
            ) + ' 评 ',
            1,
            /* TEXT */
          ),
  ...
  const InfoCard = /* @__PURE__ */ _export_sfc(_sfc_main, [
    ['render', _sfc_render],
    ['__scopeId', 'data-v-31459c9c'],
  ]);
  registerRenderer(InfoCard, {
    type: 'h5-uni-info-card',
    framework: 'vue3',
    // 使用vue3自定义组件充当爱速搭平台预览模块
  });
});
