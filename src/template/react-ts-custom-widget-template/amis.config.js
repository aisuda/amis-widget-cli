...
module.exports = {
  ...
  dev: {
    entry: { // 本地编辑器中预览自定义组件
      index: [
        './src/index.ts', // widget/info-card.tsx
        './src/widget/plugin/info-card-plugin.tsx',
      ],
    },
    // 用于开启本地调试模式的相关配置信息
  ...
  build2lib: {
    entry: {
      // 自定义组件入口文件
      reactInfoCard: './src/index.ts', // widget/info-card.tsx
      reactInfoCardPlugin: './src/widget/plugin/info-card-plugin.tsx'
    },
    // 用于构建生产环境代码的相关配置信息
    NODE_ENV: 'production',
