...
module.exports = {
  ...
  linkDebug: {
    entry: { // 外链调试（爱速搭中预览本地自定义组件）
      index: [
        './src/h5Components/qui-flow/renderer.js',
        './src/h5Components/qui-flow/plugin.js',
      ],
    },
    NODE_ENV: 'production',
    port: 80,
  ...
  build2lib: {
    entry: {
      renderer: './src/h5Components/qui-flow/renderer.js',
      plugin: './src/h5Components/qui-flow/plugin.js',
    },
    // 用于构建生产环境代码的相关配置信息
